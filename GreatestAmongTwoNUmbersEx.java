...
public class GreatestAmongTwoNUmbersEx {
	public static void main(String args[]) {
		...
		int b = in.nextInt(); //assigning that input2 to int variable b
		if (a > b) { // checking for the condition
			System.out.println(a + " " + "is greater");// printing  the result as output
		} else {
			System.out.println(b + " " + "is greater"); // printing  the result as output 
